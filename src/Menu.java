...
public class Menu {
		...
		File_IM im = new File_IM();
		
		public void introScreen() {
			System.out.println();
			System.out.println("-------------------------------------------------");
			System.out.println("          DEVELOPED BY ABHILIPSA NAYAK           ");
			System.out.println("-------------------------------------------------");
		...
		public void subMenu() {
			...
			do {
				...
				case 1: 
						...
						fileName = file.trim();
						try {
							im.createNewFile(Main.path, fileName);
						}catch(NullPointerException e) {
							System.out.println(e.getMessage());
						}catch(IOException e) {
				...
				case 2: 
						...
						fileName = file.trim();
						try {
							im.deleteFile(Main.path, fileName);
						}catch(NullPointerException e) {
							System.out.println(e.getMessage());
						}catch(IOException e) {
				...
				case 3: 
						...
						fileName = file.trim();
						try {
							im.searchFile(Main.path, fileName);
						}catch(NullPointerException e) {
							System.out.println(e.getMessage());
						}catch(IllegalArgumentException e) {
							System.out.println(e.getMessage());
